...
from ui.contactoperations import (
    edit_contact, deletecontact_flow, add_contact_flow, view_by_location_flow,sort_contacts_flow, file_io_flow,
...
def manage_contacts(selected_book):
    ...
    while True:
        ...
        if choice == "1":
            ...
            sort_contacts_flow(selected_book)
        elif choice == "6":
            print("GoodBye!")
